...
```bash
extra-facts build --source-url <docx-url> --out-dir dist --mode literal|tts [--cache .cache] [--omit-id]
extra-facts build --docx <local.docx> --out-dir dist --mode literal|tts [--omit-id]
```
